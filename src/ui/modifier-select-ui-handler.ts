...
export default class ModifierSelectUiHandler extends AwaitableUiHandler {
  ...
  setup() {
    ...
    const transferButtonText = addTextObject(this.scene, -4, -2, i18next.t("fightUiHandler:transfer_text"), TextStyle.PARTY);
    ...
    const checkButtonText = addTextObject(this.scene, -4, -2,  i18next.t("fightUiHandler:check_team_text"), TextStyle.PARTY);
    ...
    const rerollButtonText = addTextObject(this.scene, -4, -2,  i18next.t("fightUiHandler:reroll_text"), TextStyle.PARTY);
    ...
    this.lockRarityButtonText = addTextObject(this.scene, -4, -2,  i18next.t("fightUiHandler:lock_rarities_text"), TextStyle.PARTY);
  ...
  setCursor(cursor: integer): boolean {
    ...
    if (this.rowCursor) {
      ...
      ui.showText(i18next.t("fightUiHandler:reroll_description"));
    } else if (cursor === 1) {
      this.cursorObj.setPosition((this.scene.game.canvas.width / 6) - 120, -60);
      ui.showText(i18next.t("fightUiHandler:transfer_description"));
    } else if (cursor === 2) {
      this.cursorObj.setPosition((this.scene.game.canvas.width / 6) - 60, -60);
      ui.showText(i18next.t("fightUiHandler:check_team_description"));
    } else {
      this.cursorObj.setPosition(6, -60);
      ui.showText(i18next.t("fightUiHandler:lock_rarities_description"));
    }
